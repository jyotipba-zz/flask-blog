...
from my_blog.users.utils import  send_reset_email, save_picture
...
def account():
    ...
    if form.validate_on_submit():
        ...
        form.email.data = current_user.email             # to fill the form with current info
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash("Dear {}, your password has been updated. You are now able to log in", 'success')
        return redirect(url_for('users.login'))
